...
# Set all versions
SLIM_VERSION := TheKang-$(PRODUCT_VERSION_MAJOR)-$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(SLIM_POSTFIX)
SLIM_MOD_VERSION := TheKang-$(SLIM_BUILD)-$(PRODUCT_VERSION_MAJOR)-Slim-$(PRODUCT_VERSION_MAINTENANCE)$(SLIM_POSTFIX)
